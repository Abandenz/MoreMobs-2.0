...
public class HellSkeleton {
	...
	public static void spawnHellSkeleton(Location loc, int amount) {
		...
		while (i < amount) {
			...
			HS.addPotionEffect(new PotionEffect(PotionEffectType.JUMP,
					2147483647, 1));
			HS.addPotionEffect(new PotionEffect(PotionEffectType.SPEED,
					2147483647, 2));
			HS.addPotionEffect(new PotionEffect(
					PotionEffectType.INCREASE_DAMAGE, 2147483647, 4));
			HS.addPotionEffect(new PotionEffect(
