...
public class SkeletonWarriorGold {
	...
	public static boolean isSkeletonWarriorGold(SkeletonWarriorGold MMSkeletonWarriorGold) {
		if(MMSkeletonWarriorGold instanceof Skeleton) {
			Skeleton SkeletonWarriorGold = (Skeleton) MMSkeletonWarriorGold;
			if(SkeletonWarriorGold.getEquipment().getChestplate().equals(new ItemStack(315))) {
				return true;
			}
		}
		return false;
	...
	public static void spawnSkeletonWarriorGold(Location loc, int amount) {
		...
		while(i < amount) {
			...
			SkeletonWarriorIron.getEquipment().setChestplate(new ItemStack(Material.GOLD_CHESTPLATE, 1));
			SkeletonWarriorIron.getEquipment().setHelmet(new ItemStack(Material.GOLD_HELMET, 1));
			SkeletonWarriorIron.getEquipment().setLeggings(new ItemStack(Material.GOLD_LEGGINGS, 1));
			SkeletonWarriorIron.getEquipment().setBoots(new ItemStack(Material.GOLD_BOOTS, 1));
