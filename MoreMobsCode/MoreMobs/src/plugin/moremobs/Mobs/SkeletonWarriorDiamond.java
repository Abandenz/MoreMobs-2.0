...
public class SkeletonWarriorDiamond {
	...
	public static boolean isSkeletonWarriorDiamond(SkeletonWarriorDiamond MMSkeletonWarriorDiamond) {
		if(MMSkeletonWarriorDiamond instanceof Skeleton) {
			Skeleton SkeletonWarriorDiamond = (Skeleton) MMSkeletonWarriorDiamond;
			if(SkeletonWarriorDiamond.getEquipment().getChestplate().equals(new ItemStack(311))) {
				return true;
			}
		}
		return false;
	...
	public static void spawnSkeletonWarriorDiamond(Location loc, int amount) {
		...
		while(i < amount) {
			...
			SkeletonWarriorIron.getEquipment().setChestplate(new ItemStack(Material.DIAMOND_CHESTPLATE, 1));
			SkeletonWarriorIron.getEquipment().setHelmet(new ItemStack(Material.DIAMOND_HELMET, 1));
			SkeletonWarriorIron.getEquipment().setLeggings(new ItemStack(Material.DIAMOND_LEGGINGS, 1));
			SkeletonWarriorIron.getEquipment().setBoots(new ItemStack(Material.DIAMOND_BOOTS, 1));
